...
const strings = {
  ru: {
    ...
    subscription_qr_renew_hint: "Отсканируйте телефоном, чтобы открыть @meow_meow_vpn_bot и продлить подписку.",
  ...
  en: {
    ...
    subscription_qr_renew_hint: "Scan with your phone to open @meow_meow_vpn_bot and renew the subscription.",
